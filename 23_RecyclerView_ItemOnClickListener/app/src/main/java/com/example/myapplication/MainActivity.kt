...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Inisalisasikan recycler view
            //untuk melakukan otomatis lebar dan tinggi ukuran device
    ...
    private fun showRecyclerList(){
        ...
        //Memunculkan toast pada interface ketika onClick berjalan
    ...
    //Untuk Menangani kejadian ketika item dipilih
