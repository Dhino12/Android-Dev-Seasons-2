...
class NotificationService : IntentService("NotificationService") {
    ...
    companion object{
        ...
        val CHANNEL_NAME :CharSequence = "Yui Channel"

        //Untuk membaca inputan dari direct message kita bisa menggunakan remoteinput dengan kode seperti di atas.
        // Kemudian untuk menerimanya, kita menggunakan method onReceivedi kelas NotificationBroadcastReceiver.
    ...
    private fun showNotification(){
        ...
        //RemoteInput membawa informasi seperti label, action, dan key
        // yang digunakan untuk mengambil input dari direct reply.
        val remoteInput = RemoteInput.Builder(KEY_REPLY)
            .setLabel(replyLabel)
            .build()

        //Notification Action Berfungsi untuk menghubungkan action dan remote input. Kita memerlukan sebuah ikon, label, dan pending intent.
        ...
        /*
        * Untuk Android OREO Perlu menambahkan Channel Notification
        * materi ini akan dibahas di modul extended
        * */
