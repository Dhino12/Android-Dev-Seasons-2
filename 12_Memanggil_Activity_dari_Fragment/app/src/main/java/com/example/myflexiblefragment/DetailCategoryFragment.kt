...
class DetailCategoryFragment : Fragment(), View.OnClickListener{
    ...
    override fun onClick(v: View) {
        when(v.id){
            ...
            R.id.btn_show_dialog -> {
                //menggunakan childFragmentManager untuk kondisi nested fragement
                    //karena OptionDialogFragment akan dipanggil didalam objek yang sudah ada
                        //yakni DetailCategoryFragment
                val mFragmentManager = childFragmentManager
                val mOptionDialogFragment = OptionDialogFragment()
                //Untuk menampilkan OptionDialogFragment kelayar sebagai fragment yang mengambang diatas
    ...
    internal var optionDialogListener: OptionDialogFragment.OnOptionDialogListener = object :
        ...
        //Kemudian baris ini akan dipanggil untuk menampilkan nilai yang ada di onOptionChosen() pada
            //OptionDialogFramgent
