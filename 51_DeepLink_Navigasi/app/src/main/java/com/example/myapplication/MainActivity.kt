...
class MainActivity : AppCompatActivity(), View.OnClickListener{
    ...
    //============================================================================================
        //Di sini kita memanfaatkan TaskStackBuilder API untuk membuat sebuah back stack baru yang akan
        // dimasukkan ke dalam task yang sudah ada. Ketika kelas DetailActivity dijalankan,
        // kemudian pengguna menekan tombol back baik itu system back button maupun up button,
        // maka pengguna akan diarahkan ke ParentActivity dari DetailActivity.
        // ParentActivity tersebut didefinisikan di berkas AndroidManifest.xml
