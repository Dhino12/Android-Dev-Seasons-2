...
//        calendar.set(Calendar.SECOND, 0)
    ...
    fun setRepeatingAlarm(context: Context,type:String ,time:String, message: String){
        ...
        //Penggunaan metode setInexactRepeating() adalah pilihan lebih tepat karena Android akan menjalankan alarm ini secara bersamaan dengan alarm lain.
    ...
    //==========================================================================================
    //=============================== Menambahkan Cancle Alarm ==============================
    //==========================================================================================
    //Karena tipe alarm yang dikirimkan adalah TYPE_REPEATING, maka id yang digunakan adalah NOTIF_ID_REPEATING yang bernilai 101.
    // Setelah memperoleh id tersebut, maka kita dapat mengetahui intent-nya. Dan kemudian kita dapat membatalkan alarmnya.
